...
public class PaodingAnalyzerBeanBak extends Analyzer {
	...
	*//**
	 ...
	 * @param knife
	 *//*
	public PaodingAnalyzerBeanBak(Knife knife) {
		this.knife = knife;
	}
	...
	*//**
	 ...
	 * @param mode
	 *//*
	public PaodingAnalyzerBeanBak(Knife knife, int mode) {
		this.knife = knife;
		this.mode = mode;
	}
	...
	*//**
	 ...
	 * @param mode
	 *//*
	public PaodingAnalyzerBeanBak(Knife knife, String mode) {
		this.knife = knife;
		this.setMode(mode);
	}
